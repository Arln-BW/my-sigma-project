...
void LowerPart::Movement(float V1, float V2, float V3, float V4, float control){
  if(V1 > 0){
    if(control) {roda_1.ccw(abs(V2));}
    else {roda_1.ccw(abs(V1));}

  } else if(V1 < 0){
    if(control) {roda_1.cw(abs(V2));}
    else {roda_1.cw(abs(V1));}
